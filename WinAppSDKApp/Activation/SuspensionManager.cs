...
namespace WinAppSDKApp.Activation
{
    ...
    internal sealed class SuspensionManager
    {
        ...
        /// Any <see cref="Frame"/> instances registered with <see cref="RegisterFrame"/> will also preserve their current navigation stack, which in turn gives their active <see cref="Page"/> an opportunity to save its state.
        /// </summary>
        ...
        /// <returns>An asynchronous task that reflects when session state has been read.
        /// The content of <see cref="SessionState"/> should not be relied upon until this task completes.</returns>
        ...
        private static readonly DependencyProperty FrameSessionBaseKeyProperty = DependencyProperty.RegisterAttached("_FrameSessionBaseKeyParams", typeof(string), typeof(SuspensionManager), null);
        ...
        /// <param name="sessionBaseKey">An optional key that identifies the type of session. This can be used to distinguish between multiple application launch scenarios.</param>
